...
- Iniciar `BankingSystem.API` (puerto 7000)
- Iniciar `BankingSystem.gRPC` (puerto 7001) 
- Ejecutar `BankingSystem.WinForms`
...
```bash
dotnet test BankingSystem.Tests --filter Category=ACID
```

### Pruebas de Concurrencia
```bash
dotnet test BankingSystem.Tests --filter Category=Concurrency
```
...
```
BankingSystem/
├── BankingSystem.Core/              # Modelos y contratos
│   ├── Models/                      # Entidades de dominio
│   ├── DTOs/                        # Data Transfer Objects
│   └── Interfaces/                  # Contratos de servicios
├── BankingSystem.Data/              # Acceso a datos
│   ├── BankingDbContext.cs         # Contexto de Entity Framework
│   └── Repositories/               # Implementaciones de repositorio
├── BankingSystem.Business/          # Lógica de negocio
│   └── Services/                   # Servicios de aplicación
├── BankingSystem.API/              # Web API REST
│   └── Controllers/                # Controladores de API
├── BankingSystem.gRPC/             # Servidor gRPC
│   ├── Protos/                     # Definiciones de protocolo
│   └── Services/                   # Implementaciones gRPC
├── BankingSystem.WinForms/         # Interfaz de usuario
│   └── Forms/                      # Formularios Windows
├── BankingSystem.Tests/            # Pruebas automatizadas
...
- **Nombre del Estudiante** - *Desarrollo inicial* - [GitHub](https://github.com/username)
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=BankingSystemDB;Integrated Security=true;MultipleActiveResultSets=true"
  }
}
```
...
1. **En Visual Studio:**
   ...
   - Configurar:
     - BankingSystem.API → Start
     - BankingSystem.gRPC → Start
     - BankingSystem.WinForms → Start
